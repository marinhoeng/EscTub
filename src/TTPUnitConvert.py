class TTPUnitConvert:
    def __init__(self):
        ...
        self.__fPressure = {
            ...
            "kpa": 1.0e-3,
            "mpa": 1.0e-6,
            "atm": 9.86923266716013e-6,
            "bar": 1.0e-5,
            "psi": 1.45037737730209e-4,
            "torr": 0.007500617,
            "mmhg": 0.007500617,
        }
        ...
        self.__fVolration = {
            "m3/m3": 1.0,
            "scf/stb": 5.61458333333333,
            "mscf/stb": 5.61458333333333e-3,
            "stb/scf": 0.178107606679035,
            "stb/mscf": 178.107606679035,
            "bbl/stb": 1.0,
        }
        ...
        self.__fPermeability = {
            "m2": 1.0,
            "sq·ft": 10.764262648008613,
            "darcy": 1013249965828.1448,
        }

        # Thermal Conductivity Convertion Dictionary
        self.__fThermalConductivity = {
            "w/(m·k)": 1.0,
            "kw/(m·k)": 1.0e-3,
            "cal/(s·cm·c)": 0.00238846,
            "btu/(h·ft·f)": 0.5777893,
            "cal/(s·m·c)": 0.23884599999999997,
        }

        # Heat Capacity
        self.__fHeatCapacity = {
            "j/k": 1.0,
            "j/c": 1.0,
            "cal/c": 0.2388459,
            "btu/f": 5.265649e-4,
        ...
        self.__fAngle = {
            "radian": 1.0,
            "degree": 57.295779513082,
            "minutes": 3437.7467707849,
            "seconds": 206264.8062471,
            "revolution": 0.1591549430919,
        }
    ...
    def mCalc_Conv_Double(self, inputUnit, outputUnit, input):
        ...
        if inputUnit in self.__fListPressure and outputUnit in self.__fListPressure:
            ...
            inputUnit in self.__fListSurfaceTension
            and outputUnit in self.__fListSurfaceTension
        ):
            outputDouble = self.mCalc_Conv_SurfaceTension(input, inputUnit, outputUnit)

        elif (
            inputUnit in self.__fListTemperature
            and outputUnit in self.__fListTemperature
        ):
            ...
            inputUnit in self.__fListThermalConductivity
            and outputUnit in self.__fListThermalConductivity
        ):
            outputDouble = self.mCalc_Conv_ThermalConductivity(
                input, inputUnit, outputUnit
            )

        elif (
            inputUnit in self.__fListHeatCapacity
            and outputUnit in self.__fListHeatCapacity
        ):
            ...
            inputUnit in self.__fListMolarVolume
            and outputUnit in self.__fListMolarVolume
        ):
            outputDouble = self.mCalc_Conv_MolarVolume(input, inputUnit, outputUnit)

        elif (
            inputUnit in self.__fListSpecificEnergy
            and outputUnit in self.__fListSpecificEnergy
        ):
            outputDouble = self.mCalc_Conv_SpecificEnergy(input, inputUnit, outputUnit)

        elif (
            inputUnit in self.__fListMolarDensity
            and outputUnit in self.__fListMolarDensity
        ):
            outputDouble = self.mCalc_Conv_MolarDensity(input, inputUnit, outputUnit)

        elif (
            inputUnit in self.__fListPermeability
            and outputUnit in self.__fListPermeability
        ):
    ...
    def mCalc_Conv_Vector(self, inputUnit, outputUnit, input):
        ...
        for i in range(0, len(input)):
            if inputUnit in self.__fListPressure and outputUnit in self.__fListPressure:
                outputVector.append(
                    self.mCalc_Conv_Pressure(input[i], inputUnit, outputUnit)
                )
            elif inputUnit in self.__fListVolume and outputUnit in self.__fListVolume:
                outputVector.append(
                    self.mCalc_Conv_Volume(input[i], inputUnit, outputUnit)
                )
            elif inputUnit in self.__fListDensity and outputUnit in self.__fListDensity:
                outputVector.append(
                    self.mCalc_Conv_Density(input[i], inputUnit, outputUnit)
                )
            elif (
                inputUnit in self.__fListViscosity
                and outputUnit in self.__fListViscosity
            ):
                outputVector.append(
                    self.mCalc_Conv_Viscosity(input[i], inputUnit, outputUnit)
                )
            elif inputUnit in self.__fListMass and outputUnit in self.__fListMass:
                outputVector.append(
                    self.mCalc_Conv_Mass(input[i], inputUnit, outputUnit)
                )
            elif (
                inputUnit in self.__fListVolration
                and outputUnit in self.__fListVolration
            ):
                outputVector.append(
                    self.mCalc_Conv_Volration(input[i], inputUnit, outputUnit)
                )
            elif inputUnit in self.__fListLength and outputUnit in self.__fListLength:
                outputVector.append(
                    self.mCalc_Conv_Length(input[i], inputUnit, outputUnit)
                )
            elif inputUnit in self.__fListComp and outputUnit in self.__fListComp:
                outputVector.append(
                    self.mCalc_Conv_Comp(input[i], inputUnit, outputUnit)
                )
            elif (
                inputUnit in self.__fListSurfaceTension
                and outputUnit in self.__fListSurfaceTension
                ...
                outputVector.append(
                    self.mCalc_Conv_SurfaceTension(input[i], inputUnit, outputUnit)
                )
            elif (
                inputUnit in self.__fListTemperature
                and outputUnit in self.__fListTemperature
                ...
                outputVector.append(
                    self.mCalc_Conv_Temperature(input[i], inputUnit, outputUnit)
                )
            elif (
                inputUnit in self.__fListVelocity and outputUnit in self.__fListVelocity
            ):
                outputVector.append(
                    self.mCalc_Conv_Velocity(input[i], inputUnit, outputUnit)
                )
            elif (
                inputUnit in self.__fListThermalConductivity
                and outputUnit in self.__fListThermalConductivity
                ...
                outputVector.append(
                    self.mCalc_Conv_ThermalConductivity(input[i], inputUnit, outputUnit)
                )
            elif (
                inputUnit in self.__fListHeatCapacity
                and outputUnit in self.__fListHeatCapacity
                ...
                outputVector.append(
                    self.mCalc_Conv_HeatCapacity(input[i], inputUnit, outputUnit)
                )
            elif inputUnit in self.__fListEnergy and outputUnit in self.__fListEnergy:
                outputVector.append(
                    self.mCalc_Conv_Energy(input[i], inputUnit, outputUnit)
                )
            elif (
                inputUnit in self.__fListMassFlow and outputUnit in self.__fListMassFlow
            ):
                outputVector.append(
                    self.mCalc_Conv_MassFlow(input[i], inputUnit, outputUnit)
                )
            elif inputUnit in self.__fListIP and outputUnit in self.__fListIP:
                outputVector.append(self.mCalc_Conv_IP(input[i], inputUnit, outputUnit))
            elif (
                inputUnit in self.__fListMolarFlow
                and outputUnit in self.__fListMolarFlow
            ):
                outputVector.append(
                    self.mCalc_Conv_MolarFlow(input[i], inputUnit, outputUnit)
                )
            elif inputUnit in self.__fListWork and outputUnit in self.__fListWork:
                outputVector.append(
                    self.mCalc_Conv_Work(input[i], inputUnit, outputUnit)
                )
            elif (
                inputUnit in self.__fListMolarVolume
                and outputUnit in self.__fListMolarVolume
                ...
                outputVector.append(
                    self.mCalc_Conv_MolarVolume(input[i], inputUnit, outputUnit)
                )
            elif (
                inputUnit in self.__fListSpecificEnergy
                and outputUnit in self.__fListSpecificEnergy
                ...
                outputVector.append(
                    self.mCalc_Conv_SpecificEnergy(input[i], inputUnit, outputUnit)
                )
            elif (
                inputUnit in self.__fListMolarDensity
                and outputUnit in self.__fListMolarDensity
                ...
                outputVector.append(
                    self.mCalc_Conv_MolarDensity(input[i], inputUnit, outputUnit)
                )
            elif (
                inputUnit in self.__fListPermeability
                and outputUnit in self.__fListPermeability
                ...
                outputVector.append(
                    self.mCalc_Conv_Permeability(input[i], inputUnit, outputUnit)
                )
            elif inputUnit in self.__fListJouleTC and outputUnit in self.__fListJouleTC:
                outputVector.append(
                    self.mCalc_Conv_JouleTC(input[i], inputUnit, outputUnit)
                )
            elif inputUnit in self.__fListAngle and outputUnit in self.__fListAngle:
                outputVector.append(
                    self.mCalc_Conv_Angle(input[i], inputUnit, outputUnit)
                )
    ...
    def mCalc_Conv_Matrix(self, inputUnit, outputUnit, input):
        ...
        for i in range(0, len(input)):
            for j in range(0, len(input[0])):
                if (
                    inputUnit in self.__fListPressure
                    and outputUnit in self.__fListPressure
                ):
                    tempList.append(
                        self.mCalc_Conv_Pressure(input[i][j], inputUnit, outputUnit)
                    )
                elif (
                    inputUnit in self.__fListVolume and outputUnit in self.__fListVolume
                ):
                    tempList.append(
                        self.mCalc_Conv_Volume(input[i][j], inputUnit, outputUnit)
                    )
                elif (
                    inputUnit in self.__fListDensity
                    and outputUnit in self.__fListDensity
                ):
                    tempList.append(
                        self.mCalc_Conv_Density(input[i][j], inputUnit, outputUnit)
                    )
                elif (
                    inputUnit in self.__fListViscosity
                    and outputUnit in self.__fListViscosity
                    ...
                    tempList.append(
                        self.mCalc_Conv_Viscosity(input[i][j], inputUnit, outputUnit)
                    )
                elif inputUnit in self.__fListMass and outputUnit in self.__fListMass:
                    tempList.append(
                        self.mCalc_Conv_Mass(input[i][j], inputUnit, outputUnit)
                    )
                elif (
                    inputUnit in self.__fListVolration
                    and outputUnit in self.__fListVolration
                    ...
                    tempList.append(
                        self.mCalc_Conv_Volration(input[i][j], inputUnit, outputUnit)
                    )
                elif (
                    inputUnit in self.__fListLength and outputUnit in self.__fListLength
                ):
                    tempList.append(
                        self.mCalc_Conv_Length(input[i][j], inputUnit, outputUnit)
                    )
                elif inputUnit in self.__fListComp and outputUnit in self.__fListComp:
                    tempList.append(
                        self.mCalc_Conv_Comp(input[i][j], inputUnit, outputUnit)
                    )
                elif (
                    inputUnit in self.__fListSurfaceTension
                    and outputUnit in self.__fListSurfaceTension
                    ...
                    tempList.append(
                        self.mCalc_Conv_SurfaceTension(
                            input[i][j], inputUnit, outputUnit
                        )
                    )
                elif (
                    inputUnit in self.__fListTemperature
                    ...
                    tempList.append(
                        self.mCalc_Conv_Temperature(input[i][j], inputUnit, outputUnit)
                    )
                elif (
                    inputUnit in self.__fListVelocity
                    and outputUnit in self.__fListVelocity
                ):
                    tempList.append(
                        self.mCalc_Conv_Velocity(input[i][j], inputUnit, outputUnit)
                    )
                elif (
                    inputUnit in self.__fListThermalConductivity
                    and outputUnit in self.__fListThermalConductivity
                    ...
                    tempList.append(
                        self.mCalc_Conv_ThermalConductivity(
                            input[i][j], inputUnit, outputUnit
                        )
                    )
                elif (
                    ...
                    tempList.append(
                        self.mCalc_Conv_HeatCapacity(input[i][j], inputUnit, outputUnit)
                    )
                elif (
                    inputUnit in self.__fListEnergy and outputUnit in self.__fListEnergy
                ):
                    tempList.append(
                        self.mCalc_Conv_Energy(input[i][j], inputUnit, outputUnit)
                    )
                elif (
                    inputUnit in self.__fListMassFlow
                    and outputUnit in self.__fListMassFlow
                ):
                    tempList.append(
                        self.mCalc_Conv_MassFlow(input[i][j], inputUnit, outputUnit)
                    )
                elif inputUnit in self.__fListIP and outputUnit in self.__fListIP:
                    tempList.append(
                        self.mCalc_Conv_IP(input[i][j], inputUnit, outputUnit)
                    )
                elif (
                    inputUnit in self.__fListMolarFlow
                    and outputUnit in self.__fListMolarFlow
                    ...
                    tempList.append(
                        self.mCalc_Conv_MolarFlow(input[i][j], inputUnit, outputUnit)
                    )
                elif inputUnit in self.__fListWork and outputUnit in self.__fListWork:
                    tempList.append(
                        self.mCalc_Conv_Work(input[i][j], inputUnit, outputUnit)
                    )
                elif (
                    inputUnit in self.__fListMolarVolume
                    and outputUnit in self.__fListMolarVolume
                    ...
                    tempList.append(
                        self.mCalc_Conv_MolarVolume(input[i][j], inputUnit, outputUnit)
                    )
                elif (
                    inputUnit in self.__fListSpecificEnergy
                    and outputUnit in self.__fListSpecificEnergy
                    ...
                    tempList.append(
                        self.mCalc_Conv_SpecificEnergy(
                            input[i][j], inputUnit, outputUnit
                        )
                    )
                elif (
                    ...
                    tempList.append(
                        self.mCalc_Conv_MolarDensity(input[i][j], inputUnit, outputUnit)
                    )
                elif (
                    inputUnit in self.__fListPermeability
                    and outputUnit in self.__fListPermeability
                    ...
                    tempList.append(
                        self.mCalc_Conv_Permeability(input[i][j], inputUnit, outputUnit)
                    )
                elif (
                    inputUnit in self.__fListJouleTC
                    and outputUnit in self.__fListJouleTC
                ):
                    tempList.append(
                        self.mCalc_Conv_JouleTC(input[i][j], inputUnit, outputUnit)
                    )
                elif inputUnit in self.__fListAngle and outputUnit in self.__fListAngle:
                    tempList.append(
                        self.mCalc_Conv_Angle(input[i][j], inputUnit, outputUnit)
                    )
    ...
    def sCalc_Conv_JouleTCIS(jouthc_in, unit_in):
        if unit_in == "k/pa":
            ...
            rJouleTCIS = jouthc_in * 1.0e-3
        elif unit_in == "k/mpa":
            rJouleTCIS = jouthc_in * 1.0e-6
        elif unit_in == "k/atm":
            rJouleTCIS = jouthc_in * 9.86923266716013e-6
        elif unit_in == "k/bar":
            rJouleTCIS = jouthc_in * 1.0e-5
        elif unit_in == "k/psi":
            ...
            rJouleTCIS = (jouthc_in + 273.15) * 1.0e-3
        elif unit_in == "c/mpa":
            rJouleTCIS = (jouthc_in + 273.15) * 1.0e-6
        elif unit_in == "c/atm":
            rJouleTCIS = (jouthc_in + 273.15) * 9.86923266716013e-6
        elif unit_in == "c/bar":
            rJouleTCIS = (jouthc_in + 273.15) * 1.0e-5
        elif unit_in == "c/psi":
            ...
            rJouleTCIS = (1.0e-3 * jouthc_in + 459.67) / 1.8
        elif unit_in == "f/mpa":
            rJouleTCIS = (1.0e-6 * jouthc_in + 459.67) / 1.8
        elif unit_in == "f/atm":
            rJouleTCIS = (9.86923266716013e-6 * jouthc_in + 459.67) / 1.8
        elif unit_in == "f/bar":
            rJouleTCIS = (1.0e-5 * jouthc_in + 459.67) / 1.8
        elif unit_in == "f/psi":
            ...
            rJouleTCIS = (1.0e-3 * jouthc_in) / 1.8
        elif unit_in == "r/mpa":
            rJouleTCIS = (1.0e-6 * jouthc_in) / 1.8
        elif unit_in == "r/atm":
            rJouleTCIS = (9.86923266716013e-6 * jouthc_in) / 1.8
        elif unit_in == "r/bar":
            rJouleTCIS = (1.0e-5 * jouthc_in) / 1.8
        elif unit_in == "r/psi":
    ...
    def sCalc_Conv_JouleTC(jouthcsi, unit_out):
        if unit_out == "k/pa":
            ...
            rJouleTCOut = jouthcsi / 1.0e-3
        elif unit_out == "k/mpa":
            rJouleTCOut = jouthcsi / 1.0e-6
        elif unit_out == "k/atm":
            rJouleTCOut = jouthcsi / 9.86923266716013e-6
        elif unit_out == "k/bar":
            rJouleTCOut = jouthcsi / 1.0e-5
        elif unit_out == "k/psi":
            ...
            rJouleTCOut = (jouthcsi - 273.15) / 1.0e-3
        elif unit_out == "c/mpa":
            rJouleTCOut = (jouthcsi - 273.15) / 1.0e-6
        elif unit_out == "c/atm":
            rJouleTCOut = (jouthcsi - 273.15) / 9.86923266716013e-6
        elif unit_out == "c/bar":
            rJouleTCOut = (jouthcsi - 273.15) / 1.0e-5
        elif unit_out == "c/psi":
            ...
            rJouleTCOut = (1.8 * jouthcsi - 459.67) / 1.0e-3
        elif unit_out == "f/mpa":
            rJouleTCOut = (1.8 * jouthcsi - 459.67) / 1.0e-6
        elif unit_out == "f/atm":
            rJouleTCOut = (1.8 * jouthcsi - 459.67) / 9.86923266716013e-6
        elif unit_out == "f/bar":
            rJouleTCOut = (1.8 * jouthcsi - 459.67) / 1.0e-5
        elif unit_out == "f/psi":
            ...
            rJouleTCOut = (1.8 * jouthcsi) / 1.0e-3
        elif unit_out == "r/mpa":
            rJouleTCOut = (1.8 * jouthcsi) / 1.0e-6
        elif unit_out == "r/atm":
            rJouleTCOut = (1.8 * jouthcsi) / 9.86923266716013e-6
        elif unit_out == "r/bar":
            rJouleTCOut = (1.8 * jouthcsi) / 1.0e-5
        elif unit_out == "r/psi":
